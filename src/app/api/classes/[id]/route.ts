// app/api/school_classes/[id]/route.ts

import { NextRequest, NextResponse } from "next/server";

const BASE_URL = "https://inventory-backend-hm7r.onrender.com/api/v1/school_classes";
...
export async function GET(req: NextRequest, { params }: Context) {
  ...
  try {
    ...
    console.error("Error fetching school class by ID:", err);
