// app/api/inventory_transactions/[id]/route.ts
...
// GET /api/inventory_transactions/[id]
export async function GET(req: NextRequest, { params }: Context) {
  ...
  try {
    ...
    console.error("Error fetching inventory transaction by ID:", err);
...
// PUT /api/inventory_transactions/[id]
...
// DELETE /api/inventory_transactions/[id]
