...
export default function ClassInventoryEntitlementsPage() {
  ...
  const canCreate = canPerformAction("Entitlements", "create");
  const canUpdate = canPerformAction("Entitlements", "update");
  const canDelete = canPerformAction("Entitlements", "delete");
