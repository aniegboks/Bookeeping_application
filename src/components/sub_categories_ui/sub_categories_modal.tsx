...
import SmallLoading from "@/components/ui/small_loader"; // import your loading component
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full">
        ...
        <div className="p-6">
          ...
          <div className="flex justify-end gap-3 mt-6 pt-4 border-t border-gray-200">
            ...
            >
              {loading ? <span className="flex">
                <SmallLoading />
                <p className="text-sm ml-2">Updating</p>
              </span> : editingItem ? "Update" : "Create"}
            </button>
          </div>
        </div>
      </div>
